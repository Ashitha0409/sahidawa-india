...
3.  **Update All Locale Files:**
    ...
    - For _every_ `.json` file present (e.g., `en.json`, `hi.json`, `bn.json`), add the newly defined keys under their respective namespaces.
