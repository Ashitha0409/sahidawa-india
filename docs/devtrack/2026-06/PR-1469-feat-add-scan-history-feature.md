...
- **Client-Side Only:** All IndexedDB operations _must_ be performed in client components or within `useEffect` hooks to avoid errors during server-side rendering.
